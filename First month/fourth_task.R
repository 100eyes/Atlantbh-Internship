...
summary(model)
plot(cooks.distance(model), pch = 16, col = "blue", main = "Cooks distance of first model", ylab = "Cooks distance")
summary(model2)
summary(model3)
...
plot(yelp_business$review_count, yelp_business$stars, pch = 16, col = "blue", main = "Prediction of linear model", xlab = "Review count", ylab = "Stars")
abline(model)
